    ...
    <section class="py-20 bg-slate-50 relative">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="swiper hotels-swiper">
          ...
          <button class="hotel-prev absolute top-32 left-0 -translate-y-1/2 z-10 w-12 h-12 bg-cyan-500 rounded-full flex items-center justify-center shadow-lg hover:bg-cyan-600 hover:scale-105 transition-all duration-300 group cursor-pointer">
            <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
            </svg>
          </button>
          <button class="hotel-next absolute top-32 right-0 -translate-y-1/2 z-10 w-12 h-12 bg-cyan-500 rounded-full flex items-center justify-center shadow-lg hover:bg-cyan-600 hover:scale-105 transition-all duration-300 group cursor-pointer">
            <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-20 bg-slate-50">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="swiper tours-swiper">
          ...
          <div class="swiper-pagination mt-8"></div>
          <button class="tour-prev absolute top-32 left-0 -translate-y-1/2 z-10 w-12 h-12 bg-cyan-500 rounded-full flex items-center justify-center shadow-lg hover:bg-cyan-600 hover:scale-105 transition-all duration-300 group cursor-pointer">
            <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
            </svg>
          </button>
          <button class="tour-next absolute top-32 right-0 -translate-y-1/2 z-10 w-12 h-12 bg-cyan-500 rounded-full flex items-center justify-center shadow-lg hover:bg-cyan-600 hover:scale-105 transition-all duration-300 group cursor-pointer">
            <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
          </button>
